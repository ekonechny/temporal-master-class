...
const CustomerTaskQueue = "general"
...
// temporal.Customer activity names
const (
	AssortmentGetProductsActivityName = "temporal.Customer.AssortmentGetProducts"
)
...
type CustomerActivities interface {
	// temporal.Customer.AssortmentGetProducts implements a(n) temporal.Customer.AssortmentGetProducts activity definition
	AssortmentGetProducts(ctx context.Context, req *AssortmentGetProductsRequest) (*AssortmentGetProductsResponse, error)
}
...
func RegisterCustomerActivities(r worker.ActivityRegistry, activities CustomerActivities) {
	RegisterAssortmentGetProductsActivity(r, activities.AssortmentGetProducts)
}

// RegisterAssortmentGetProductsActivity registers a temporal.Customer.AssortmentGetProducts activity
func RegisterAssortmentGetProductsActivity(r worker.ActivityRegistry, fn func(context.Context, *AssortmentGetProductsRequest) (*AssortmentGetProductsResponse, error)) {
	r.RegisterActivityWithOptions(fn, activity.RegisterOptions{
		Name: AssortmentGetProductsActivityName,
	})
}

// AssortmentGetProductsFuture describes a(n) temporal.Customer.AssortmentGetProducts activity execution
type AssortmentGetProductsFuture struct {
	Future workflow.Future
}

// Get blocks on the activity's completion, returning the response
func (f *AssortmentGetProductsFuture) Get(ctx workflow.Context) (*AssortmentGetProductsResponse, error) {
	var resp AssortmentGetProductsResponse
...
func (f *AssortmentGetProductsFuture) Select(sel workflow.Selector, fn func(*AssortmentGetProductsFuture)) workflow.Selector {
...
// AssortmentGetProducts executes a(n) temporal.Customer.AssortmentGetProducts activity
func AssortmentGetProducts(ctx workflow.Context, req *AssortmentGetProductsRequest, options ...*AssortmentGetProductsActivityOptions) (*AssortmentGetProductsResponse, error) {
	return AssortmentGetProductsAsync(ctx, req, options...).Get(ctx)
}

// AssortmentGetProductsAsync executes a(n) temporal.Customer.AssortmentGetProducts activity (asynchronously)
func AssortmentGetProductsAsync(ctx workflow.Context, req *AssortmentGetProductsRequest, options ...*AssortmentGetProductsActivityOptions) *AssortmentGetProductsFuture {
	var o *AssortmentGetProductsActivityOptions
	if len(options) > 0 && options[0] != nil {
		o = options[0]
	} else {
		o = NewAssortmentGetProductsActivityOptions()
	}
	var err error
	if ctx, err = o.Build(ctx); err != nil {
		errF, errS := workflow.NewFuture(ctx)
		errS.SetError(err)
		return &AssortmentGetProductsFuture{Future: errF}
	}
	activity := AssortmentGetProductsActivityName
	future := &AssortmentGetProductsFuture{Future: workflow.ExecuteActivity(ctx, activity, req)}
	return future
}

// AssortmentGetProductsLocal executes a(n) temporal.Customer.AssortmentGetProducts activity (locally)
func AssortmentGetProductsLocal(ctx workflow.Context, req *AssortmentGetProductsRequest, options ...*AssortmentGetProductsLocalActivityOptions) (*AssortmentGetProductsResponse, error) {
	return AssortmentGetProductsLocalAsync(ctx, req, options...).Get(ctx)
}

// AssortmentGetProductsLocalAsync executes a(n) temporal.Customer.AssortmentGetProducts activity (asynchronously, locally)
func AssortmentGetProductsLocalAsync(ctx workflow.Context, req *AssortmentGetProductsRequest, options ...*AssortmentGetProductsLocalActivityOptions) *AssortmentGetProductsFuture {
	var o *AssortmentGetProductsLocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		o = options[0]
	} else {
		o = NewAssortmentGetProductsLocalActivityOptions()
	}
	var err error
	if ctx, err = o.Build(ctx); err != nil {
		errF, errS := workflow.NewFuture(ctx)
	...
	future := &AssortmentGetProductsFuture{Future: workflow.ExecuteLocalActivity(ctx, activity, req)}
	return future
}

// AssortmentGetProductsActivityOptions provides configuration for a(n) temporal.Customer.AssortmentGetProducts activity
type AssortmentGetProductsActivityOptions struct {
...
// NewAssortmentGetProductsActivityOptions initializes a new AssortmentGetProductsActivityOptions value
func NewAssortmentGetProductsActivityOptions() *AssortmentGetProductsActivityOptions {
	return &AssortmentGetProductsActivityOptions{}
}
...
func (o *AssortmentGetProductsActivityOptions) Build(ctx workflow.Context) (workflow.Context, error) {
	opts := o.options
...
func (o *AssortmentGetProductsActivityOptions) WithActivityOptions(options workflow.ActivityOptions) *AssortmentGetProductsActivityOptions {
	o.options = options
	return o
}

// WithHeartbeatTimeout sets the HeartbeatTimeout value
func (o *AssortmentGetProductsActivityOptions) WithHeartbeatTimeout(d time.Duration) *AssortmentGetProductsActivityOptions {
	o.heartbeatTimeout = &d
	return o
}

// WithRetryPolicy sets the RetryPolicy value
func (o *AssortmentGetProductsActivityOptions) WithRetryPolicy(policy *temporal.RetryPolicy) *AssortmentGetProductsActivityOptions {
	o.retryPolicy = policy
	return o
}

// WithScheduleToCloseTimeout sets the ScheduleToCloseTimeout value
func (o *AssortmentGetProductsActivityOptions) WithScheduleToCloseTimeout(d time.Duration) *AssortmentGetProductsActivityOptions {
	o.scheduleToCloseTimeout = &d
	return o
}

// WithScheduleToStartTimeout sets the ScheduleToStartTimeout value
func (o *AssortmentGetProductsActivityOptions) WithScheduleToStartTimeout(d time.Duration) *AssortmentGetProductsActivityOptions {
	o.scheduleToStartTimeout = &d
	return o
}

// WithStartToCloseTimeout sets the StartToCloseTimeout value
func (o *AssortmentGetProductsActivityOptions) WithStartToCloseTimeout(d time.Duration) *AssortmentGetProductsActivityOptions {
	o.startToCloseTimeout = &d
	return o
}

// WithTaskQueue sets the TaskQueue value
func (o *AssortmentGetProductsActivityOptions) WithTaskQueue(tq string) *AssortmentGetProductsActivityOptions {
	o.taskQueue = &tq
	return o
}

// WithWaitForCancellation sets the WaitForCancellation value
func (o *AssortmentGetProductsActivityOptions) WithWaitForCancellation(wait bool) *AssortmentGetProductsActivityOptions {
	o.waitForCancellation = &wait
	return o
}

// AssortmentGetProductsLocalActivityOptions provides configuration for a(n) temporal.Customer.AssortmentGetProducts activity
type AssortmentGetProductsLocalActivityOptions struct {
	options                workflow.LocalActivityOptions
	retryPolicy            *temporal.RetryPolicy
	scheduleToCloseTimeout *time.Duration
	startToCloseTimeout    *time.Duration
	fn                     func(context.Context, *AssortmentGetProductsRequest) (*AssortmentGetProductsResponse, error)
}

// NewAssortmentGetProductsLocalActivityOptions initializes a new AssortmentGetProductsLocalActivityOptions value
func NewAssortmentGetProductsLocalActivityOptions() *AssortmentGetProductsLocalActivityOptions {
	return &AssortmentGetProductsLocalActivityOptions{}
}
...
func (o *AssortmentGetProductsLocalActivityOptions) Build(ctx workflow.Context) (workflow.Context, error) {
	opts := o.options
	if v := o.retryPolicy; v != nil {
		opts.RetryPolicy = v
	} else if opts.RetryPolicy == nil {
...
// Local specifies a custom temporal.Customer.AssortmentGetProducts implementation
func (o *AssortmentGetProductsLocalActivityOptions) Local(fn func(context.Context, *AssortmentGetProductsRequest) (*AssortmentGetProductsResponse, error)) *AssortmentGetProductsLocalActivityOptions {
	o.fn = fn
	return o
}

// WithLocalActivityOptions specifies an initial LocalActivityOptions value to which defaults will be applied
func (o *AssortmentGetProductsLocalActivityOptions) WithLocalActivityOptions(options workflow.LocalActivityOptions) *AssortmentGetProductsLocalActivityOptions {
	o.options = options
	return o
}

// WithRetryPolicy sets the RetryPolicy value
func (o *AssortmentGetProductsLocalActivityOptions) WithRetryPolicy(policy *temporal.RetryPolicy) *AssortmentGetProductsLocalActivityOptions {
	o.retryPolicy = policy
	return o
}

// WithScheduleToCloseTimeout sets the ScheduleToCloseTimeout value
func (o *AssortmentGetProductsLocalActivityOptions) WithScheduleToCloseTimeout(d time.Duration) *AssortmentGetProductsLocalActivityOptions {
	o.scheduleToCloseTimeout = &d
	return o
}

// WithStartToCloseTimeout sets the StartToCloseTimeout value
func (o *AssortmentGetProductsLocalActivityOptions) WithStartToCloseTimeout(d time.Duration) *AssortmentGetProductsLocalActivityOptions {
	o.startToCloseTimeout = &d
	return o
}
...
func (c *TestCustomerClient) CheckoutAsync(ctx context.Context, workflowID string, runID string, req *CheckoutRequest, opts ...*CheckoutOptions) (CheckoutHandle, error) {
	...
	c.env.UpdateWorkflow(CheckoutUpdateName, workflowID, uc, req)
...
func (c *TestCustomerClient) UpdateCartAsync(ctx context.Context, workflowID string, runID string, req *UpdateCartRequest, opts ...*UpdateCartOptions) (UpdateCartHandle, error) {
	...
	uc := testutil.NewUpdateCallbacks()
	c.env.UpdateWorkflow(UpdateCartUpdateName, workflowID, uc, req)
...
func (c *TestCustomerClient) UpdateProfileAsync(ctx context.Context, workflowID string, runID string, req *UpdateProfileRequest, opts ...*UpdateProfileOptions) (UpdateProfileHandle, error) {
	...
	uc := testutil.NewUpdateCallbacks()
	c.env.UpdateWorkflow(UpdateProfileUpdateName, workflowID, uc, req)
	...
	commands := []*v2.Command{
		...
		},
		{
			...
			Flags: []v2.Flag{
				...
				&v2.StringSliceFlag{
					Name:     "products",
					Usage:    "set the value of the operation's \"Products\" parameter (json-encoded: {id: <string>, qty: <int32>})",
					Category: "INPUT",
				},
			},
			Action: func(cmd *v2.Context) error {
...
func UnmarshalCliFlagsToSetAddressRequest(cmd *v2.Context) (*SetAddressRequest, error) {
	...
	if cmd.IsSet("address") {
		hasValues = true
		var v Address
		if err := protojson.Unmarshal([]byte(cmd.String("address")), &v); err != nil {
...
func UnmarshalCliFlagsToCheckoutRequest(cmd *v2.Context) (*CheckoutRequest, error) {
...
func UnmarshalCliFlagsToUpdateCartRequest(cmd *v2.Context) (*UpdateCartRequest, error) {
...
func UnmarshalCliFlagsToUpdateProfileRequest(cmd *v2.Context) (*UpdateProfileRequest, error) {
...
func UnmarshalCliFlagsToCustomerFlowRequest(cmd *v2.Context) (*CustomerFlowRequest, error) {
